...
const ImageDeblurring = () => {
  ...
  const processImageWithBackend = async (file) => {
    ...
    try {
      ...
      if (activeTab === "text") {
        endpoint = "https://console.cloud.google.com/cloud-build/builds;region=global/00b0b70f-aba2-4ed4-b172-7092a4ba4a4b?hl=en&invt=AbtvUg&project=orbital-bank-455617-v6&supportedpurview=folder:5000/predict/text";
      } else if (activeTab === "general") {
        endpoint = "https://console.cloud.google.com/cloud-build/builds;region=global/00b0b70f-aba2-4ed4-b172-7092a4ba4a4b?hl=en&invt=AbtvUg&project=orbital-bank-455617-v6&supportedpurview=folder:5000/predict/general";
      } else {
