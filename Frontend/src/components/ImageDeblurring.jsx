...
const ImageDeblurring = () => {
  ...
  const processImageWithBackend = async (file) => {
    ...
    try {
      ...
      if (activeTab === "text") {
        endpoint = "https://image-deblurring-151835338056.asia-south1.run.app/predict/text";
      } else if (activeTab === "general") {
        endpoint = "https://image-deblurring-151835338056.asia-south1.run.app/predict/general";
      } else {
